...
prepare_consumption = function(d,socr,colors){
  ...
  d2 = aggregated_data(data.frame(d[2]),socr,"Profit-centric")
  d3 = aggregated_data(data.frame(d[3]),socr,"consumer-biased")
  d4 = aggregated_data(data.frame(d[4]),socr,"balanced")
  d5 = aggregated_data(data.frame(d[5]),socr,"popular-uncorrelated-profit")
  d6 = aggregated_data(data.frame(d[6]),socr,"popular-correlated-profit")
