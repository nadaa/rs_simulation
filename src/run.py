...
if __name__ == "__main__":
    ...
    var_params = {
        "recommendation_strategy": model_parameters["recommendation_strategy"],
        "quantile_consumer_expectation": model_parameters[
    ...
    for i in range(len(br_df["DataCollector"])):
        ...
        br_step_model_data = br_step_model_data._append(i_run_model)
        i_run_agent = br_df["DataCollector"][i].get_agent_vars_dataframe()
        br_step_agent_data = br_step_agent_data._append(i_run_agent)
